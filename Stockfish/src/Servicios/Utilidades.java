...
public class Utilidades {
	...
	public static void verificarEventosCercanos(List<Evento> eventos, String chatId, Usuario usuario) {
		...
		// Datos del usuario para personalizar el mensaje
		String nombreCompleto = (usuario != null) ? usuario.getNombres() + " " + usuario.getApellidos() : "Estudiante";
		String facultad = (usuario != null && usuario.getFacultad() != null) ? usuario.getFacultad() : "";
